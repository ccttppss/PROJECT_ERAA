...
## 🏆 최신 실험 결과 (Experimental Results)

로컬 LLM (gpt-oss:20b)과 **Target-aware Prompting** (Aspect/Context 집중) 기법을 활용하여 압도적인 성능 향상을 달성했습니다.

| 실험 (Experiment) | 태스크 (Task) | Baseline | **제안 방법 (Ours)** | 개선폭 |
| :--- | :--- | :---: | :---: | :---: |
| **SemEval 2014** | ABSA (Laptop) | 53.45% | **79.78%** | **+26.33%p** 🚀 |
| **MAMS** | Mixed Sentiment | 45.43% | **68.26%** | **+22.83%p** 🚀 |
| **SARC** | Sarcasm Detection | 50.00% | **62.10%** | **+12.10%p** 🚀 |

> *전체 실험 로그와 스크립트는 `experiments/` 디렉토리에서 확인할 수 있습니다.*
